riot.tag2('gantt', '<div class="gantt-chart-container"> <div class="gantt-chart-content"> <div class="gantt-chart-header"> <div class="gantt-chart-header-title center-content"> <p>Developers</p> </div> <div class="gantt-chart-header-schedule"> <div class="gantt-chart-header-schedule-list scroll-fix"> <div each="{date in opts.layout_dates}" class="gantt-chart-header-schedule-date center-content"> <p>{date.str}</p> </div> </div> </div> </div> <div class="gantt-users-container"> <div each="{person in opts.people}" class="gantt-user-container"> <div class="gantt-user-list"> <div class="gantt-user-header center-content"> <p>{person.username}</p> </div> <div class="gantt-user-list-tasks"> <div each="{task in person.tasks}" class="gantt-user-list-task task center-content"> <p>{task.title}</p> </div> </div> </div> <div class="gantt-user-schedule"> <div class="gantt-user-header center-content"> <div class="gantt-task-schedule"> <div each="{task, i in person.tasks}" riot-style="margin-top: 15px; margin-left: {task.date_offset * 0.1}px; width: {task.date_duration * 0.1}px; background: {opts.color_palette[i % opts.color_palette.length].background}; border: solid 2px {opts.color_palette[i % opts.color_palette.length].border};" class="task-bar"> </div> </div> </div> <div class="gantt-task-schedule-container scroll-fix"> <div each="{task, i in person.tasks}" class="gantt-task-schedule"> <div each="{date in opts.layout_dates}" class="gantt-schedule-task-area-cell task center-content"> <p></p> </div> <div riot-style="margin-left: {task.date_offset}px; width: {task.date_duration}px; background: {opts.color_palette[i % opts.color_palette.length].background}; border: solid 2px {opts.color_palette[i % opts.color_palette.length].border};" class="task-bar"> </div> </div> </div> </div> </div> </div> </div> </div>', 'gantt .gantt-chart-container,[data-is="gantt"] .gantt-chart-container{ display: flex; width: 100%; height: 100%; justify-content: center; align-items: center; } gantt .gantt-chart-content,[data-is="gantt"] .gantt-chart-content{ display: flex; flex-direction: column; width: 95%; height: 95%; background: #ddd; border-radius: 8px; } gantt .gantt-chart-header,[data-is="gantt"] .gantt-chart-header{ display: flex; width: 100%; height: 80px; } gantt .gantt-chart-header-title,[data-is="gantt"] .gantt-chart-header-title{ display: flex; width: 25%; align-items: center; } gantt .gantt-chart-header-schedule,[data-is="gantt"] .gantt-chart-header-schedule{ display: flex; width: 75%; } gantt .gantt-chart-header-schedule-list,[data-is="gantt"] .gantt-chart-header-schedule-list{ display: flex; width: 100%; } gantt .gantt-chart-header-schedule-date,[data-is="gantt"] .gantt-chart-header-schedule-date{ display: flex; border: solid 1px #ccc; align-items: center; } gantt .gantt-users-container,[data-is="gantt"] .gantt-users-container{ display: flex; flex-direction: column; } gantt .gantt-user-container,[data-is="gantt"] .gantt-user-container{ display: flex; } gantt .gantt-user-list,[data-is="gantt"] .gantt-user-list{ display: flex; flex-direction: column; width: 25%; border-right: solid 2px #ddd; background: #eee; } gantt .gantt-user-header,[data-is="gantt"] .gantt-user-header{ display: flex; height: 60px; border-bottom: solid 2px #ddd; border-top: solid 2px #ddd } gantt .task,[data-is="gantt"] .task{ height: 30px; } gantt .task-bar-container,[data-is="gantt"] .task-bar-container{ position: relative; } gantt .task-bar,[data-is="gantt"] .task-bar{ position: absolute; // background: rgba(255,0,0,0.03); // border: solid 2px #f00; border-radius: 5px; height: 22px; margin-top: 4px; } gantt .gantt-user-list-tasks,[data-is="gantt"] .gantt-user-list-tasks{ display: flex; flex-direction: column; } gantt .gantt-user-list-task,[data-is="gantt"] .gantt-user-list-task{ display: flex; } gantt .gantt-user-schedule,[data-is="gantt"] .gantt-user-schedule{ display: flex; flex-direction: column; width: 75%; background: #fff; } gantt .gantt-task-schedule-container,[data-is="gantt"] .gantt-task-schedule-container{ position: relative; } gantt .gantt-task-schedule,[data-is="gantt"] .gantt-task-schedule{ display: flex; flex-direction: row; width: 100%; height: 100%; } gantt .gantt-schedule-task-area-cell,[data-is="gantt"] .gantt-schedule-task-area-cell{ display: flex; border: solid 1px #eee; } gantt .scroll-fix,[data-is="gantt"] .scroll-fix{ overflow-x: auto; } gantt .scroll-fix::-webkit-scrollbar,[data-is="gantt"] .scroll-fix::-webkit-scrollbar{ display: none; } gantt .center-content,[data-is="gantt"] .center-content{ align-items: center; justify-content: center; } gantt p,[data-is="gantt"] p{ text-align: center; width: 120px; margin: 0; }', '', function(opts) {
